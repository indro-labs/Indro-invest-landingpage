    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="hidden items-center gap-8 sm:flex">
          ...
          {/* "Get started" bypasses the quiz — signs up (or lands signed-in
              users on the dashboard) directly, per the Take Quiz / Get
              Started split. "My account" above already covers the
              signed-in case, so this hides once signed in. */}
          {clerkEnabled ? (
            <Show when="signed-out">
              <Link
