...
export default function Home() {
  return (
    <div className="relative text-ink">
      ...
      {/* ----------------------------- Hero ---------------------------- */}
      <section className="relative mx-auto flex max-w-6xl flex-col items-center px-6 pb-24 pt-20 text-center sm:pt-28 md:pb-32 md:pt-32">
        ...
        <div className="mb-6 flex flex-col items-center gap-3 sm:flex-row">
          <a href={STRIPE_PAYMENT_LINK} className="btn-solid inline-flex items-center px-8 py-3.5 text-base">
            Get founding access · $99/yr
          </a>
        ...
        <p className="text-[13px] text-ink-faint">
          127 traders signed up. 10 founding spots remain.
        </p>
      </section>

      {/* ------------------------ Interactive demo ------------------------ */}
      <section id="preview" className="relative mx-auto max-w-6xl scroll-mt-8 px-6 pb-24 pt-8 md:pb-32">
        <div className="mb-12 text-center">
          <h2 className="display mb-4 text-3xl sm:text-[2.4rem]">See what Selnite sees.</h2>
          <p className="mx-auto max-w-lg text-base text-ink-soft">
            The dashboard in development, walking through 90 days of one trader&apos;s
            psychology. Real design, sample data. Founding members get it first.
          </p>
        </div>
        <ProductDemo />
      </section>
      ...
      {/* --------------------- Feature showcase --------------------- */}
      <section id="features" className="scroll-mt-8 border-t border-line-soft px-6 py-20 md:py-24">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-lg text-base leading-relaxed text-ink-soft">
              Most trading losses come from broken process, not broken strategy. Selnite
              turns discipline into something you can see: routines you actually follow,
              hours that actually pay you, and patterns caught before they cost you again.
              Every panel below is clickable.
            </p>
          </div>
          <FeatureShowcase />
        </div>
      ...
      {/* --------------------------- Principles -------------------------- */}
      <section id="principles" className="scroll-mt-8 border-y border-line-soft bg-bg-sunk px-6 py-20 md:py-24">
      ...
      {/* --------------------------- Founding Member CTA -------------------------- */}
      <section id="founding" className="relative scroll-mt-8 border-t border-line-soft px-6 py-20 md:py-24">
        <div className="glow" aria-hidden="true" />
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-lg text-base leading-relaxed text-ink-soft">
            ...
            have signed up. Ten founding spots exist. When they&apos;re gone, this
            price is gone.
          </p>
